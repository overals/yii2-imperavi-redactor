		...
		return {
			init: function()
			{
				var items = [
					...
					['Claim Widget with money background', '<span class="c-acf__cta"><span class="c-acf__cta-money"><span class="c-acf__cta-text">Data breached? You might have a right to compensation - up to $750</span><a class="c-acf__cta-button btn-dc" href="/claim">Claim NOW</a></span></span>'],
